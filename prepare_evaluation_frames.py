...
def main():
    ...
    print("=" * 60)
    print("  1. Gán nhãn thủ công bằng LabelImg / CVAT / Roboflow Annotate.")
    print("     Chỉ gán 4 lớp trong evaluation/classes.txt (car=0,")
    print("     motorcycle=1, bus=2, truck=3).")
    print("  2. Lưu nhãn định dạng YOLO vào evaluation/labels/,")
    print("     mỗi ảnh một file .txt cùng tên (kể cả file rỗng).")
    print("  3. Kiểm tra dataset:")
    print("     python evaluate_pipelines.py --validate-only")
    print("  4. Chạy đánh giá:")
    print("     python evaluate_pipelines.py")
    return 0
